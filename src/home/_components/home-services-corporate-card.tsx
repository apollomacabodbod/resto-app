import womanHaving from "src/assets/home-services/woman-having.jpg";
import bookNow from "src/assets/home-services/booknow.svg";

export default function HomeServicesCorporateCard() {
  return (
    <>
      <div className="flex flex-col  mt-[3.9375em] mb-[7.375em]">
